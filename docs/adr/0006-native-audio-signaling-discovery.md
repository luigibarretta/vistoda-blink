...
advertises two-way audio. It sends no live, SDP, ICE, microphone or speaker
message, starts no media session and closes immediately after the upgrade.
